...
const Sidebar = () => {
  ...
  return (
    <>
    <div style={{width: toggleSidebar? "100%" : "max-content", height: "100vh", backgroundColor: toggleSidebar ? "rgb(0, 0, 0, .54)" : "transparent"}} className="fixed z-50 top-0 left-0 h-full bg-black/[.54] phone:fixed laptop:relative">
      <motion.div
        variants={sidebarVariant}
        animate={sidebarAnimation}
        className="top-0 left-0 h-full bg-black w-[280px] phone:fixed phone:-left-[100%] laptop:relative laptop:-left-[0%]"
      >
        <div

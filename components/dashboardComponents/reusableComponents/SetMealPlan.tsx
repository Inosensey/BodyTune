...
// Types
import { IngredientTypes, MealInfoTypes, nutritionTypes } from "@/types/mealTypes";
...
const SetMealPlan = ({
  ...
  return (
    <>
      ...
      >
        <div className="bg-black rounded-t-lg pt-4 py-2 w-12/12">
          <div
        ...
        {showMealPlanHtml && (
          <div className="flex gap-1 bg-black rounded-b-lg pt-2 pb-4 px-2 flex-col midtablet:flex-1 mdtablet:h-[80%] laptop:w-12/12">
            <div className="flex flex-col gap-2 phone:h-[35%] tablet:h-[43%] laptop:h-[39%]">

...
interface props {
  ...
  views: string;
  likes: string;
  setToggleBodyTuneWorkoutDetails: React.Dispatch<React.SetStateAction<boolean>>;
}
    ...
    <div className="flex flex-col gap-2 font-quickSand text-sm bg-lightPrimary rounded-lg w-[280px] h-max p-4">
      <div className="flex flex-col gap-2 justify-between">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-base font-bold text-lightSecondary underline">{exercisePlanName}</p>

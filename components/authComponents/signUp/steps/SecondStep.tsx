        ...
        <div className="text-sm flex flex-col gap-1">
          ...
          <ul className="flex flex-col gap-1">
            <li className="flex items-center gap-2">
              <FontAwesomeIcon className="text-xs text-secondary" icon={faCircleCheck} />
              <div className="border-2 w-3 h-3 rounded-2xl"></div> 1
              letter
            </li>
            <li className="flex items-center gap-2">
            <FontAwesomeIcon className="text-xs text-secondary" icon={faCircleCheck} />
              <div className="border-2 w-3 h-3 rounded-2xl"></div> 1 number
            </li>
            <li className="flex items-center gap-2">
            <FontAwesomeIcon className="text-xs text-secondary" icon={faCircleCheck} />
              <div className="border-2 w-3 h-3 rounded-2xl"></div> 1 number or
              special character (example: # ? ! &)
            </li>
            <li className="flex items-center gap-2">
            <FontAwesomeIcon className="text-xs text-secondary" icon={faCircleCheck} />
              <div className="border-2 w-3 h-3 rounded-2xl"></div> At least 8
              characters
            </li>
          </ul>
        </div>

...
type IcBaselineStarBorderProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};

export function IcBaselineStarBorder(props: IcBaselineStarBorderProps) {
  return (
    <svg
...
export default IcBaselineStarBorder;

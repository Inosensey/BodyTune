...
type SolarSettingsLinearProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};

export function SolarSettingsLinear(props: SolarSettingsLinearProps) {
  return (
    <svg
...
export default SolarSettingsLinear;

...
type SolarUndoLeftRoundSquareOutlineProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};

export function SolarUndoLeftRoundSquareOutline(
  props: SolarUndoLeftRoundSquareOutlineProps
) {
  return (
    <svg
...
export default SolarUndoLeftRoundSquareOutline;

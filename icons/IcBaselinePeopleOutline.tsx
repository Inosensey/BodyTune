...
type IcBaselinePeopleOutlineProps = SVGProps<SVGSVGElement> & {
  color: string;
  width?: string;
  height?: string;
};
...
export function IcBaselinePeopleOutline(props: IcBaselinePeopleOutlineProps) {
  return (
    <svg
...
export default IcBaselinePeopleOutline;
